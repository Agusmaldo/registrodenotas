<?php
/**
 * Referencia filter form base class.
 *
 * @package    ferro05
 * @subpackage filter
 ...
 */
abstract class BaseReferenciaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('referencia_filters[%s]');
